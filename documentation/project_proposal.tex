...
\todo{I would change SAC to the algorithm I've sent yesterday. It's doable and it's able to produce better results in non-deterministic envs \\ Example of implementation could be this https://github.com/hemilpanchiwala/Hindsight-Experience-Replay}
...
\todo{We might still use SAC as a baseline method}
