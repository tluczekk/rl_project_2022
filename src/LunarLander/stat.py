...
with open('ll_base_eval.txt', 'r') as be:
    for line in be:
        base_eval.append(float(line))

with open('ll_weight_eval.txt', 'r') as we:
    for line in we:
        weight_eval.append(float(line))

with open('ll_uni_eval.txt', 'r') as ue:
    for line in ue:
        uni_eval.append(float(line))
